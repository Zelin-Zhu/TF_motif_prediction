...
seqs_500_750=np.load("D:/workspace of spyder/毕业设计/my project data/datafile/H1hesc/H1hesc_500_750.npy")
seqs_750_1000=np.load("D:/workspace of spyder/毕业设计/my project data/datafile/H1hesc/H1hesc_750_1000.npy")
seqs_250_500=np.load("D:/workspace of spyder/毕业设计/my project data/datafile/H1hesc/H1hesc_250_500.npy")
seqs_background=np.load("D:/workspace of spyder/毕业设计/my project data/datafile/H1hesc/H1hesc_background.npy")
seqs_0_250=np.load("D:/workspace of spyder/毕业设计/my project data/datafile/H1hesc/H1hesc_0_250.npy")
...
model.save('D:/workspace of spyder/毕业设计/my project data/model_file/Binary_classification_H1hesc.h5') 
# 加载模型，同时加载了模型的结构、权重等信息
loaded_model = tf.keras.models.load_model('D:/workspace of spyder/毕业设计/my project data/model_file/Binary_classification_H1hesc.h5')
